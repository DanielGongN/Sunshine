...
set MSYS2_ROOT=E:\WorkComp\msys64
set MSYS2_MINGW64=%MSYS2_ROOT%\mingw64
set MSYS2_USR=%MSYS2_ROOT%\usr\bin

REM ── 安装 MSYS2 mingw-w64-x86_64 依赖（幂等，已装则跳过）────────────────
echo [INFO] Installing / updating required MSYS2 mingw-w64-x86_64 packages via pacman ...
"%MSYS2_USR%\bash.exe" -lc "pacman -S --noconfirm --needed mingw-w64-x86_64-gcc mingw-w64-x86_64-pkgconf mingw-w64-x86_64-openssl mingw-w64-x86_64-curl mingw-w64-x86_64-opus mingw-w64-x86_64-miniupnpc mingw-w64-x86_64-boost mingw-w64-x86_64-cppwinrt mingw-w64-x86_64-MinHook"
if errorlevel 1 (
